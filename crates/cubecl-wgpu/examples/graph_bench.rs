...
//! path vs graph replay on wgpu, across kernel sizes and graph lengths.
//!
...
fn run_pass(client: &ComputeClient<WgpuRuntime>, a: &Handle, b: &Handle, cfg: &Config) {
...
fn sync(client: &ComputeClient<WgpuRuntime>, h: &Handle) {
...
fn bench_config(client: &ComputeClient<WgpuRuntime>, cfg: &Config) {
